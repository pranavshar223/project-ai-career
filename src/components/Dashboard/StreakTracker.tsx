  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-200">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">Keep your momentum going!</p>
      </div>
              ...
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${
                  day.isCompleted
                    ...
                    : day.isToday
                    ? 'bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 border-2 border-blue-300 dark:border-blue-600'
